		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
						...
						<li>
							<ul class="dropdown-menu-list scroller" style="height: 250px;">
								<li>
									<a href="#?a=view">
									<span class="photo">
									<img src="{{asset('admin/assets/admin/layout/img/avatar2.jpg')}}" alt=""/>
									</span>
									<span class="subject">
									<span class="from">
									Lisa Wong </span>
								...
								<li>
									<a href="#?a=view">
									<span class="photo">
									<img src="{{asset('admin/assets/admin/layout/img/avatar3.jpg')}}" alt=""/>
									</span>
									<span class="subject">
									<span class="from">
									Richard Doe </span>
								...
								<li>
									<a href="#?a=view">
									<span class="photo">
									<img src="{{asset('admin/assets/admin/layout/img/avatar1.jpg')}}" alt=""/>
									</span>
									<span class="subject">
									<span class="from">
									Bob Nilson </span>
				...
				<li class="dropdown dropdown-user">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
					<img alt="" class="img-circle hide1" src="{{asset('admin/assets/admin/layout/img/avatar3_small.jpg')}}"/>
