...
<link href="{{asset('admin/assets/global/plugins/select2/select2.css')}}" rel="stylesheet" type="text/css"/>
<link href="{{asset('admin/assets/admin/pages/css/login-soft.css')}}" rel="stylesheet" type="text/css"/>
...
<div class="logo">
	<a href="index.html">
	<img src="{{asset('admin/assets/admin/layout/img/logo-big.png')}}" alt=""/>
	</a>
</div>
<!-- END LOGO -->
...
<div class="content">
	...
	@include('admin::form.forgot_password')
...
<script src="{{asset('admin/assets/admin/pages/scripts/login-soft.js')}}" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
...
Demo.init(); // init demo features
  Login.init();
       ...
       $.backstretch([
        "{{asset('admin/assets/admin/pages/media/bg/1.jpg')}}",
        "{{asset('admin/assets/admin/pages/media/bg/2.jpg')}}",
        "{{asset('admin/assets/admin/pages/media/bg/3.jpg')}}",
        "{{asset('admin/assets/admin/pages/media/bg/4.jpg')}}"
        ], {
          fade: 1000,
          duration: 8000
    }
